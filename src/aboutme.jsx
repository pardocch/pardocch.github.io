...
info.projects.map((project, index) => {
    if (project.avatar) {
        const projectAvatar = require(`responsive-loader?placeholder=true&name=./assets/output-images/[name].[ext]&sizes[]=400.&sizes[]=600.&sizes[]=800!./assets/images/portfolio/${
            project.avatar
        }`);
