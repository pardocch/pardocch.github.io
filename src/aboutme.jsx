const info = {
    about: {
        ...
        skills: {
            Backend: ["PHP", "Laravel", "Codeigniter", "Wordpress", "Python", "Django", "NodeJS"],
            Frontend: ["HTML5", "CSS3", "JavaScript", {icon: "reactjs", name: "React.js"}, "jQuery", "Bootstrap", "Materialize"],
...
info.projects.map((project, index) => {
    if (project.avatar) {
        const projectAvatar = require(`responsive-loader?placeholder=true&name=../src/assets/output-images/[name].[ext]&sizes[]=400.&sizes[]=600.&sizes[]=800!./assets/images/portfolio/${
            project.avatar
        }`);
